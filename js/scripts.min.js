...
$(function(){$("#my-menu").mmenu({extensions:["theme-dark","effect-menu-slide","pagedim-black"],navbar:{title:'<a href="#" class="logo"><img src="img/logo.svg" alt="Waxom"><span>V</span>Vaxom</a>'},offCanvas:{position:"right"}});var a=$("#my-menu").data("mmenu");a.bind("open",function(){$(".hamburger").addClass("is-active")}),a.bind("close",function(){$(".hamburger").removeClass("is-active")}),$(".carousel-head").owlCarousel({loop:!0,items:1,nav:!0,smartSpeed:700,navText:['<img src="img/left.png" alt="left"/>','<img src="img/right.png" alt="right"/>'],autoplay:!1,autoplayTimeout:3e3,autoplaySpeed:900})});